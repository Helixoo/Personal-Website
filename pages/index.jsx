...
Merhaba! Ben Helixo Genelde Python ile kod yazıyorum, discord botları kodluyorum. Hobi olarak basketbol oynuyorum, logo afiş tasarımları yapıyorum
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="Helixo" src={`https://cdn.discordapp.com/attachments/977522571945848912/1000732538970587186/giphy_7.gif`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/Helixoo/`+_.name}
                      target="_blank"
                      rel="noreferrer"
