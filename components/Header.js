...
const items = [
    { icon: 'fab fa-discord', link: 'https://discord.com/users/953297817688997898' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/' },
    { icon: 'fab fa-github', link: 'https://github.com/Helixoo' },
  ]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">HELİXO</p>
